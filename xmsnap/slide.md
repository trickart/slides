...
Connected to: xcode-tools v24582
Accessibility permission granted. Will auto-click "Allow" if dialog appears.
  Automatically clicked "Allow" on Xcode permission dialog.

Selected Project:
  Name: GitHubViewer
  Path: /Users/ryotaroseki/GitHubViewer/GitHubViewer.xcodeproj
  Tab:  windowtab5

Capturing 22 snapshot(s) to: snapshots
  [22/22] Rendering GitHubViewer/GitHubViewer/ContentView.swift [preview 2/2]...
...
